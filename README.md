...
plugins {
    ...
    id("io.github.menjoo.cucumberkmp") version "0.2.1"
}

kotlin {
    sourceSets {
        commonTest.dependencies {
            implementation("io.github.menjoo.cucumberkmp:cucumber-kmp-core:0.2.1")
            implementation("io.github.menjoo.cucumberkmp:cucumber-kmp-annotations:0.2.1")
        }
    }
}
```
